    ...
    impl Boss {
        pub fn new() -> Boss {
            let boss = Boss {
                ...
                particles_number: 0,
                mainhand: BossEquipmentItem {
                    item_type: "air".to_string(),
                    enchantments: [].to_vec(),
                },
                offhand: BossEquipmentItem {
                    item_type: "air".to_string(),
                    enchantments: [].to_vec(),
                },
                helmet: BossEquipmentItem {
                    item_type: "air".to_string(),
                    enchantments: [].to_vec(),
                },
                chestplate: BossEquipmentItem {
                    item_type: "air".to_string(),
                    enchantments: [].to_vec(),
                },
                leggings: BossEquipmentItem {
                    item_type: "air".to_string(),
                    enchantments: [].to_vec(),
                },
                boots: BossEquipmentItem {
                    item_type: "air".to_string(),
                    enchantments: [].to_vec(),
                },
                abilities: [].to_vec(),
